  ...
  const contactInfo = [
    {
      icon: Phone,
      title: 'Phone',
      details: ['+91 9494 055 353', '+91 9398 183 297'],
      color: 'from-[#3C1285] to-[#5B3BBE]',
    },
    {
      icon: Mail,
      title: 'Email',
      details: ['aadhyacaterers01@gmail.com'],
    ...
    },
    {
      ...
      title: 'Address',
      details: [
        'Kukatpally Balajinagar (500072), Hyderabad, Telangana',
        'Uppal Chilkanagar, Hyderabad, Telangana',
      ],
...
`;
    ...
    const whatsappNumber = '919398183297'; // 9398183297
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Get In <span className="text-[#3C1285]">Touch</span>
          </h2>
